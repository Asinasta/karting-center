...
В рамках MVP не делаем новую production-БД, админку, интерфейс маршала, интерфейс владельца, CRUD расписания, онлайн-оплату, оценки маршалов, лояльность и авто-погоду.
...
| Profile | `getProfile` | `GET /profile` | Возвращает профиль текущего клиента |
