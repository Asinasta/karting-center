...
Приложение заменяет ручную запись через Telegram и маркерную доску. Клиент самостоятельно просматривает заезды без авторизации, фильтрует слоты, входит перед бронированием, бронирует места для себя и гостей, выбирает экипировку, отменяет записи и получает уведомления.
