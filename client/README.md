...
Иконки для web, Android, iOS, macOS и Windows **уже сгенерированы** и лежат в платформенных папках. Исходник: `assets/icon/app_icon.png` (красная **A** на прозрачном фоне, по центру, ~58% холста).
