...
Иконки для web, Android, iOS, macOS и Windows **уже сгенерированы** и лежат в платформенных папках. Исходник: `assets/icon/app_icon.png` (красная **A** на прозрачном фоне, ~48% холста, лёгкий сдвиг вправо).

Для **web** и лаунчеров иконки собираются с **белым** фоном `#FFFFFF` (iOS, Android adaptive icon, desktop).
